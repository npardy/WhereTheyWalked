...
ACCURACY RULES:
- You MAY use historical knowledge to explain the event's significance and context
- You MUST NOT invent specific details (exact dates, casualty numbers, specific participants) unless stated in the search results
- If specific information is not in the results, use null
- Synthesize from multiple sources in the results to build a complete picture
